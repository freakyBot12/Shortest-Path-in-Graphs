...
static ll_node_t*
create_node(const void* new_data, unsigned int data_size, int weight)
{
 ...
 */
void
ll_add_nth_node(linked_list_t* list, unsigned int n, const void* new_data, int weight)
{
	...
	new_node = create_node(new_data, list->data_size, weight);
